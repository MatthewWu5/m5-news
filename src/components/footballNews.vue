...
export default {
  ...
  methods: {
    ...
    moreNewsOnClick: function() {
      ...
      axios.get(url.getMoreData, { params: { currentMinDate: self.currentMinDate, intervalDay: self.intervalDay } })
        .then(resp => {
    ...
    refreshOnClick: function() {
      ...
      axios.get(url.getIncrementalData, { params: { maxDateList: maxDateList } })
        .then(resp => {
